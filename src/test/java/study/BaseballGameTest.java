...
public class BaseballGameTest {
    ...
    void getRandomNumberTest(){
        String randomNumber = baseballGame.getBatter();
    ...
    void isThreeDigitDuplicationTest(String input, boolean expect){
        Assertions.assertThat(baseballGame.isThreeDigitDuplication(input)).isEqualTo(expect);
    }

    @ParameterizedTest
    @CsvSource(value = {"012,true", "011,false", "01,false", "01A,false"})
    void inputValueVerificationTest(String input, boolean expect){
        Assertions.assertThat(baseballGame.inputValueVerification(input)).isEqualTo(expect);
        Assertions.assertThat(baseballGame.inputValueVerification(input)).isEqualTo(expect);
        Assertions.assertThat(baseballGame.inputValueVerification(input)).isEqualTo(expect);
        Assertions.assertThat(baseballGame.inputValueVerification(input)).isEqualTo(expect);
    }
    ...
    void judgmentResultTest(String input){
        String judgmentResult = baseballGame.judgmentResult(input);
